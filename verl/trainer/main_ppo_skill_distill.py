...
"""
PPO entrypoint for teacher-side skill-enhanced on-policy distillation.
"""
...
class TaskRunner:
    def run(self, config):
        ...
        from verl.trainer.ppo.skill_distill_trainer import SkillDistillRayPPOTrainer
        ...
        trainer = SkillDistillRayPPOTrainer(
            config=config,
            tokenizer=tokenizer,
            processor=processor,
