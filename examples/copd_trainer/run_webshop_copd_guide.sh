...
COPD_EPISODE_HINT_TEACHER_ADV_W=${COPD_EPISODE_HINT_TEACHER_ADV_W:-0.0}
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-copd-grpo_qwen2.5_3b_webshop_llm-5_step-hint-plus-v3_opd-adv-0.001_exp12}
